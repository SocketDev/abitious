...
- One rule per `- ` bullet, stating it in a single line, linking [`topic`](docs/repo/agents.md/topic.md) for the detail.
- Architecture, commands, build pipeline, and domain detail live in `docs/repo/agents.md/<topic>.md` - per-repo, never cascaded.
