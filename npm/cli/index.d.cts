...
/**
 * The napi-rs addon abi suffix for a host: `-gnu` (glibc Linux), `-musl` (musl Linux),
 * `-msvc` (Windows), or `''` (macOS).
 */
 ...
 * `<pkg>/package.json` to an absolute path (throws when not installed). Throws an
 * actionable error when no matching optional dependency is present.
 */
